...
function About() {
  return (
    <div>
      <Hero backgroundImage="https://i.imgur.com/o97zr5D.jpeg">
        <h1>Artur Piasecki</h1>
        <h2>I'm a Developer expierience with Using:<br></br> HTML, CSS, Bootstrap, JavaScript, Node, ES6, React, Axios, Vite </h2>
      </Hero>
